    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            "Categories",
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30,fontFamily: 'Eloquia_Display_ExtBd'),
          ),
        ),
        Row(
          children: [
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            text,
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14,fontFamily: 'Eloquia_Display_ExtBd'), 
